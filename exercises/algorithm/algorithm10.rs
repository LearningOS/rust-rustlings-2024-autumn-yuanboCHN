...
mod test_undirected_graph {
    ...
    fn test_add_node() {
        ...
        assert!(!graph.add_node("a")); // Should return false since "a" already exists
        assert!(graph.contains("a")); // "a" should be in the graph
        assert!(!graph.contains("b")); // "b" should not be in the graph
    }
}